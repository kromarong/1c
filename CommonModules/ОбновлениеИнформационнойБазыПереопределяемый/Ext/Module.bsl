...
//   * ОбъектыСНачальнымЗаполнением - Массив - объекты, содержащие в модуль менеджерах код начального заполнения
...
Процедура ПередОбновлениемИнформационнойБазы() Экспорт
	     //Обновляем на всякий случай идентификаторы объектов метаданных
//Справочники.ИдентификаторыОбъектовМетаданных.ОбновитьДанныеСправочника();

////Обновляем варианты отчетов
