...
//
Процедура ОткрытьФормуИсторииИзменений(Форма, ПараметрыКонтактнойИнформации, АсинхронныйВызов) Экспорт
...
//                                производиться не будет.
//
Процедура ПриОбработкеНавигационнойСсылки(Форма, Элемент, НавигационнаяСсылкаФорматированнойСтроки, СтандартнаяОбработка, АсинхронныйВызов) Экспорт
...
Процедура ПриНачалеВыбора(Форма, Элемент, Модифицированность = Истина, СтандартнаяОбработка = Ложь, ПараметрыОткрытия = Неопределено, АсинхронныйВызов) Экспорт
	СтандартнаяОбработка = Ложь;
...
Процедура ПриОчистке(Знач Форма, Знач ИмяРеквизита, АсинхронныйВызов) Экспорт
...
Процедура ПриВыполненииКоманды(Знач Форма, Знач ИмяКоманды, АсинхронныйВызов) Экспорт
...
Процедура ОбновитьКонтактнуюИнформациюФормы(Форма, Результат, АсинхронныйВызов)
	...
	Если АсинхронныйВызов Тогда
		Оповещение = Новый ОписаниеОповещения("Подключаемый_ПродолжитьОбновитьКонтактнуюИнформацию", Форма);
