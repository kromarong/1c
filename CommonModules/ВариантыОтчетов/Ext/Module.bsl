...
Функция ПользовательскиеНастройкиВариантаОтчета(ВариантОтчета, Пользователь)
	...
	Попытка
		...
		|ГДЕ
		|	ПользовательскиеНастройкиОтчетов.Вариант = &ВариантОтчета
		|	И ПользовательскиеНастройкиОтчетов.Пользователь = &Пользователь
		|
		|УПОРЯДОЧИТЬ ПО
...
Функция ВариантОтчетаПоОписанию(ОписаниеВариантаОтчета, ВариантОтчетаОснование)
	...
	ЭтоНовыйВариантОтчета = Не ЗначениеЗаполнено(ВариантОтчета.Ссылка);
	...
	Попытка
		...
		Если Не ЭтоНовыйВариантОтчета Тогда 
			ЭлементБлокировки.УстановитьЗначение("Ссылка", ВариантОтчета.Ссылка);
		КонецЕсли;
...
Процедура ОповеститьПользователейНастроекОтчета(СвойстваПользователей, ОписаниеНастроек)
	...
	Сообщение.Действия.Добавить(
		ВариантыОтчетовКлиентСервер.КодДействияСообщенияПрименитьПереданныеНастройки(), НСтр("ru = 'Применить настройки?'"));
