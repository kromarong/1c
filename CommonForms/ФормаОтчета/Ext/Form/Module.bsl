...
Процедура ОбработкаОповещения(ИмяСобытия, Параметр, Источник)
	ОповещениеОбработано = ВариантыОтчетовКлиент.ОповещениеОбработано(ИмяСобытия);
	...
	Если ОповещениеОбработано Тогда 
		...
		КонецЕсли;
	ИначеЕсли ИмяСобытия = ВариантыОтчетовКлиентСервер.КодДействияСообщенияПрименитьПереданныеНастройки() Тогда 
		ПрименитьПереданныеПользовательскиеНастройки(Параметр);
	КонецЕсли;
...
&НаКлиенте
Процедура ПрименитьПереданныеПользовательскиеНастройки(ОписаниеНастроек)
	Если ВариантМодифицирован Тогда 
