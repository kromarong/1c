...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Иначе
		...
		КонецЕсли;
		ОтобразитьНастройкиДополнительныхЯзыков(КоличествоЯзыков);
	КонецЕсли;
...
&НаСервере
Процедура ОтобразитьНастройкиДополнительныхЯзыков(КоличествоЯзыков)
	
	Настройки = Новый Структура();
	Настройки.Вставить("КодДополнительногоЯзыка1", Неопределено);
	Настройки.Вставить("КодДополнительногоЯзыка2", Неопределено);
	...
	Для каждого Язык Из Метаданные.Языки Цикл
		Если СтрСравнить(Язык.КодЯзыка, ОсновнойЯзык) <> 0 Тогда
			...
			ИначеЕсли ПустаяСтрока(Язык2ПоУмолчанию) Тогда
	...
	Если ПустаяСтрока(ДополнительныйЯзык2) Тогда
