...
стр.мест= УС(таб1.Cell(ии,3).Range.Text)    ;
стр.товар=УС(таб1.Cell(ии,2).Range.Text)    ;
//стр.КритерийПроисхождения=сокрлп(стрзаменить(таб1.Cell(ии,4).Range.Text,Символ(7),""))    ;
стр.вес=УС(таб1.Cell(ии,4).Range.Text)    ;
стр.ид=ид;
//если ии=10 тогда
...
странас=УС(таб1.Cell(ии+3,3).Range.Text)   ;

//ПодписантКонтрагента=сокрлп(стрзаменить(таб1.Cell(ии+3,2).Range.Text,Символ(7),""))    ;

ДатаДекларации=УС(таб1.Cell(ии+7,3).Range.Text)  +" 12:00:00"   ;
