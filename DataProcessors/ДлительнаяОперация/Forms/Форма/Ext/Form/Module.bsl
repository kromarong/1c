...
Функция НачатьВыполнениеФункции(НомерОперации)
	...
	Возврат ДлительныеОперации.ВыполнитьФункцию(ПараметрыВыполнения, "Обработки.ДлительнаяОперация.РассчитатьЗначение",
...
Функция НачатьВыполнениеПроцедуры(НомерОперации)
	...
	Возврат ДлительныеОперации.ВыполнитьПроцедуру(, "Обработки.ДлительнаяОперация.ВыполнитьРасчет", 
		НомерОперации, СкоростьВыполнения, ОжидаемыйРезультат = "Ошибка", ПрогрессВыполнения);
...
Функция ПараметрыОжидания()
	...
	ПараметрыОжидания.ОповещениеПользователя.НавигационнаяСсылка = "e1cib/app/Обработка.ДлительнаяОперация";
